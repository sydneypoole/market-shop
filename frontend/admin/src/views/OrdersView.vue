  ...
  <div>
    ...
    >
      ...
      <template v-else-if="detail">
        <div class="summary-grid" aria-label="订单核心信息">
          <div><small>订单状态</small><StatusTag :tone="statusTone(detail.order.status)" :label="orderStatusLabel(detail.order.status)" /></div>
          <div><small>线下应收</small><b class="summary-value">{{ money(detail.order.totalAmountFen) }}</b></div>
          <div><small>买家 / 上级</small><b class="summary-value">#{{ detail.order.buyerUserId }} / #{{ detail.order.superiorUserId }}</b></div>
        </div>
...
<style scoped>
.selection-column{width:54px}.drawer-loading{min-height:240px;display:flex;align-items:center;justify-content:center;gap:12px;color:var(--color-text-muted)}.summary-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));border-block:1px solid var(--color-border)}.summary-grid>div{min-width:0;padding:13px 15px;border-right:1px solid var(--color-border)}.summary-grid>div:last-child{border-right:0}.summary-grid small,.summary-grid b{display:block}.summary-grid small{margin-bottom:6px;color:var(--color-text-muted);font-size:12px}.summary-value{font-size:15px;font-variant-numeric:tabular-nums}.detail-columns{display:grid;grid-template-columns:1.15fr .85fr;gap:22px}.detail-section{min-width:0}.detail-section h3{margin:22px 0 8px;font-size:15px}.order-item{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid var(--color-border)}.order-item:last-child{border-bottom:0}.order-item img{width:48px;height:48px;object-fit:cover;border-radius:var(--radius-sm);background:var(--color-surface-subtle)}.order-item small,.order-item span b{display:block}.order-item small,.order-item span{color:var(--color-text-muted);font-size:12px}.order-item span{text-align:right}.address{padding:11px 13px;border-left:2px solid var(--color-border-strong);background:var(--color-surface-subtle);line-height:1.65}.muted,.empty-copy{color:var(--color-text-muted)}.timeline{list-style:none;padding:0;margin:0}.timeline li{display:flex;justify-content:space-between;gap:12px;padding:9px 0;border-bottom:1px solid var(--color-border)}.timeline li:last-child{border-bottom:0}.timeline span{color:var(--color-text-muted);font-size:12px;text-align:right}.proof{display:flex;align-items:center;gap:8px;padding:9px 0;border-bottom:1px solid var(--color-border)}.proof:last-of-type{border-bottom:0}.proof>div{flex:1}.proof small{display:block;color:var(--color-text-muted);margin-top:3px}.note{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:12px;padding:9px 0;border-bottom:1px solid var(--color-border)}.note small{color:var(--color-text-muted)}.dialog-form{display:grid;gap:13px}.state-change{display:flex;align-items:center;gap:7px}.batch-carrier{display:grid;grid-template-columns:1fr 1fr;gap:12px}.batch-list{display:grid;gap:8px;margin-top:4px}.batch-row{display:grid;grid-template-columns:minmax(150px,.7fr) minmax(180px,1fr) auto;align-items:center;gap:10px;padding:10px;border:1px solid var(--color-border);border-radius:var(--radius-md)}.batch-row span b,.batch-row span small{display:block}.batch-row span small{color:var(--color-text-muted)}.batch-row>input{min-height:40px;padding:8px 10px;border:1px solid var(--color-border-strong);border-radius:var(--radius-sm)}
@media(max-width:720px){.summary-grid,.detail-columns,.batch-carrier{grid-template-columns:1fr}.summary-grid>div{border-right:0;border-bottom:1px solid var(--color-border)}.summary-grid>div:last-child{border-bottom:0}.proof{align-items:flex-start;flex-wrap:wrap}.note{grid-template-columns:auto 1fr}.note small{grid-column:2}.batch-row{grid-template-columns:1fr}.order-item{grid-template-columns:auto 1fr}.order-item>span{grid-column:2;text-align:left}}@media(max-width:420px){.summary-grid{margin-inline:-4px}.proof .secondary,.proof .danger{flex:1}.timeline li{display:grid}.timeline span{text-align:left}}
</style>
