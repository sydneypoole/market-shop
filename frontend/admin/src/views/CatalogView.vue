...
<style scoped>
.category-strip{display:flex;gap:8px;overflow:auto;margin-bottom:14px;padding-bottom:2px;scrollbar-width:thin}.category-card{display:flex;min-width:196px;padding:7px 9px;border:1px solid var(--color-border);border-radius:var(--radius-md);background:var(--color-surface)}.category-main{flex:1;min-height:42px;padding:3px;text-align:left;border:0;background:transparent}.category-main b,.category-main small{display:block}.category-main small{color:var(--color-text-muted);margin-top:3px}.text-danger{align-self:center;padding:5px;color:var(--color-danger);border:0;background:transparent;font-size:12px}.product-cell{display:flex;align-items:center;gap:9px}.product-cell img{width:44px;height:44px;object-fit:cover;border-radius:var(--radius-sm);background:var(--color-surface-subtle)}.product-cell small,td>small{display:block;color:var(--color-text-muted);margin-top:3px}.actions{display:flex;flex-wrap:wrap;gap:6px}.product-form,.dialog-form{display:grid;gap:13px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.product-form h3{margin:7px 0 0;padding-top:14px;border-top:1px solid var(--color-border);font-size:15px}.description-head{display:flex;justify-content:space-between;align-items:center;padding-top:14px;border-top:1px solid var(--color-border)}.description-head h3{margin:0;padding:0;border:0}.preview{width:100%;height:260px;border:1px solid var(--color-border);border-radius:var(--radius-md);background:#fff}.inventory-summary{display:grid;grid-template-columns:1fr auto 1fr 1fr;align-items:center;gap:10px;padding:12px 14px;border-left:3px solid var(--color-brand);background:var(--color-surface-subtle)}.inventory-summary small,.inventory-summary b{display:block}.inventory-summary small{color:var(--color-text-muted)}.inventory-summary b{margin-top:3px;font-size:19px;font-variant-numeric:tabular-nums}.inventory-arrow{color:var(--color-brand)}.request-id{color:var(--color-text-muted);font-size:12px;word-break:break-all}.history-state{min-height:220px;display:flex;align-items:center;justify-content:center;gap:10px;color:var(--color-text-muted)}code{font-size:11px}
@media(max-width:700px){.grid{grid-template-columns:1fr}.inventory-summary{grid-template-columns:1fr auto 1fr}.inventory-summary>span:last-child{grid-column:1/-1}}@media(max-width:420px){.category-card{min-width:174px}.description-head{align-items:flex-start;gap:10px}.inventory-summary{grid-template-columns:1fr}.inventory-arrow{display:none}.inventory-summary>span:last-child{grid-column:auto}}
</style>
