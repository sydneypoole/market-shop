...
<style scoped>
.table-frame small{display:block;color:var(--color-text-muted);margin-top:4px}.table-frame code{display:block;max-width:240px;overflow:hidden;text-overflow:ellipsis;font-size:11px}.audit-meta{display:grid;grid-template-columns:90px 1fr;gap:10px;padding:14px;background:var(--color-surface-subtle);border-radius:10px}.audit-meta dt{color:var(--color-text-muted)}.audit-meta dd{margin:0}.diff{display:grid;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr);align-items:center;gap:10px;margin-top:18px}.diff pre{min-height:240px;max-height:55vh;overflow:auto;padding:12px;white-space:pre-wrap;word-break:break-word;background:#f1f4f2;border-radius:8px;font:12px/1.6 ui-monospace,monospace}.export-summary{display:grid;gap:8px}.export-summary span{padding:6px 9px;background:var(--color-surface-subtle);border-radius:8px}.export-summary p{color:var(--color-text-muted);line-height:1.6}
@media(max-width:700px){.diff{grid-template-columns:1fr}.diff>span{transform:rotate(90deg);text-align:center}.audit-meta{grid-template-columns:1fr}.audit-meta dd{margin-top:-6px}}
</style>
