...
<style scoped>
td img{width:54px;height:40px;object-fit:cover;border-radius:6px}.actions{display:flex;flex-wrap:wrap;gap:6px}.content-form{display:grid;gap:12px}.row{display:grid;grid-template-columns:1fr 1fr;gap:10px}.draft-banner{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px;background:var(--color-surface-subtle);border-radius:10px;color:var(--color-text-muted);font-size:12px}.body-head{display:flex;justify-content:space-between;align-items:center;color:var(--color-text-muted);font-size:12px;font-weight:700}.preview{width:100%;height:280px;border:1px solid var(--color-border);border-radius:9px}.discard-copy{color:var(--color-text-muted);line-height:1.7}
@media(max-width:600px){.row{grid-template-columns:1fr}.draft-banner{align-items:flex-start;flex-direction:column}}
</style>
