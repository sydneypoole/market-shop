...
<style scoped>
.detail-loading{min-height:260px;display:flex;align-items:center;justify-content:center;gap:10px;color:var(--color-text-muted)}.member-cell{display:flex;align-items:center;gap:10px;min-width:180px}.member-cell span{min-width:0}.member-cell b,.member-cell small{display:block}.member-cell small{margin-top:3px;color:var(--color-text-muted);white-space:nowrap}.phone-value{font-variant-numeric:tabular-nums;white-space:nowrap}.wechat-profile{display:grid;grid-template-columns:auto minmax(140px,.8fr) minmax(280px,1.6fr);align-items:center;gap:18px;margin-bottom:18px;padding:18px;border:1px solid var(--color-border);border-radius:var(--radius-lg);background:var(--color-surface-subtle)}.wechat-profile__identity h3{margin:0 0 10px;font:inherit;font-size:13px;color:var(--color-text-muted)}.wechat-profile__identity b,.wechat-profile__identity span{display:block}.wechat-profile__identity b{font-size:18px}.wechat-profile__identity span{margin-top:5px;color:var(--color-text-muted);font-size:12px}.wechat-profile dl{display:grid;grid-template-columns:1fr 1fr;gap:12px 18px;margin:0}.wechat-profile dl div{min-width:0}.wechat-profile dt{margin-bottom:4px;color:var(--color-text-muted);font-size:12px}.wechat-profile dd{margin:0;font-size:13px;overflow-wrap:anywhere}.metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.metrics div{padding:13px;background:var(--color-surface-subtle);border-radius:9px}.metrics small,.metrics b{display:block}.metrics small,.muted{color:var(--color-text-muted)}.metrics b{font-size:22px;margin-top:4px}.admin-dialog__body h3{font-family:inherit}.history p{display:grid;grid-template-columns:180px minmax(0,1fr) auto;gap:12px;padding:10px 0;border-bottom:1px solid var(--color-border);margin:0}.history span,.history>p>small{color:var(--color-text-muted)}.history span>small{display:block;margin-top:4px}.request-id{color:var(--color-text-muted);font-size:12px}.request-id code{word-break:break-all}
@media(max-width:700px){.wechat-profile{grid-template-columns:auto 1fr}.wechat-profile dl{grid-column:1/-1}.metrics{grid-template-columns:1fr 1fr}.history p{grid-template-columns:1fr}}
@media(max-width:460px){.wechat-profile{grid-template-columns:1fr;justify-items:start}.wechat-profile dl{grid-column:auto;grid-template-columns:1fr}.member-cell{min-width:0}}
</style>
