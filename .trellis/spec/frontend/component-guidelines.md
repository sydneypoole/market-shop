...
Admin catalog and content surfaces use the managed asset library and stable public endpoint `/api/v1/catalog/assets/{id}`. Do not hard-code RustFS URLs, local filesystem paths, or private proof URLs into product cards or content previews.
