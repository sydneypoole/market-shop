...
- Invitation tests prove lookup is read-only and absence does not call a create/regenerate port; issue/consume tests cover disabled or demoted inviters, locked revalidation, transactional revocation, rollback without relation changes, automatic inactivity/aftersale eligibility loss, and concurrent consume/admin mutation ordering.
